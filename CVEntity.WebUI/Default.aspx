<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CVEntity.WebUI.Default" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/serhan.jpg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="Default.aspx">Serhan Büber</a></h1>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="cpy-right text-center">
                <p>
					...
					<a href="Default.aspx">Serhan Büber</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
